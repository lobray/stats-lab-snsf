...
Here gender seems to be not significant, since its confidence interval includes zero. However the difference between the upper bound and zero is really small. The other significant variables in this model are PercentFemale, log(AmountRequested), IsContinuation, the InstType and Division.
