...
Also, if the project is a continuation it is more likely to be approved
...
### External Reviewers
#### Is there evidence of gender bias?
No, there is no evidence of gender bias for any criteria
```{r}
par(mfrow=c(2,2))
...
Even when combining Variables for project assessment, using a simplified version with 0 and 1, it dosen't seems that there is a bias
...
Here it seem that is more likely to get an high grade for the TrackRecord if the applicant is male!
```{r}
par(mfrow=c(2,2))
