...
kappa <- cohen.kappa(kappa.matrix.boardranking)
...
# board_log_regression <- glm(board_data$IsApproved ~ Gender + Division + Age + IsContinuation + InstType + log(AmountRequested) +
#                               Ranking + InternalApplicantTrack + ProjectAssessment + ExternalApplicantTrack +
#                               ProposalCombined + OverallGrade + Gender:Division + PercentFemale +
#                               PercentFemale:Gender, family="binomial", data = board_data)
...
```{r permute data 2, echo=FALSE, warning=FALSE}
